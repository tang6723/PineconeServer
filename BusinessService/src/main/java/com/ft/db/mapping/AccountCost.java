...
public class AccountCost {
    ...
    public Long getAccountCostID() {
        return accountCostID;
    }

    public void setAccountCostID(Long accountCostID) {
        this.accountCostID = accountCostID;
    }
