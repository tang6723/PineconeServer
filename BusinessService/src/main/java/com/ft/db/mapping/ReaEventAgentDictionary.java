 ...
 * @author Tang
 */
public class ReaEventAgentDictionary {
    private Long reaEventAgentDictionaryID;
    ...
    public Long getReaEventAgentDictionaryID() {
        return reaEventAgentDictionaryID;
    }

    public void setReaEventAgentDictionaryID(Long reaEventAgentDictionaryID) {
        this.reaEventAgentDictionaryID = reaEventAgentDictionaryID;
    }
