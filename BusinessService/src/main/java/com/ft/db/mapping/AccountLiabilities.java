...
public class AccountLiabilities {
    ...
    private Long accountLiabilitiesID;
    ...
    public Long getAccountLiabilitiesID() {
        return accountLiabilitiesID;
    }

    public void setAccountLiabilitiesID(Long accountLiabilitiesID) {
        this.accountLiabilitiesID = accountLiabilitiesID;
    }
