 ...
 * @author Tang
 */
public class ReaEnterpriseDictionary {
    private Long reaEnterpriseDictionaryID;
    ...
    public Long getReaEnterpriseDictionaryID() {
        return reaEnterpriseDictionaryID;
    }

    public void setReaEnterpriseDictionaryID(Long reaEnterpriseDictionaryID) {
