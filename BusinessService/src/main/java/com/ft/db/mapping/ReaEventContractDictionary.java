 ...
 * @author Tang
 */
public class ReaEventContractDictionary {
    private Long reaEventContractDictionaryID;
    ...
    public Long getReaEventContractDictionaryID() {
        return reaEventContractDictionaryID;
    }

    public void setReaEventContractDictionaryID(Long reaEventContractDictionaryID) {
        this.reaEventContractDictionaryID = reaEventContractDictionaryID;
    }
