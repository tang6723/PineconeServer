 ...
 * @author Tang
 */
public class AccountOwnerEquity {
    
    private Long accountOwnerEquityID;
    ...
    public Long getAccountOwnerEquityID() {
        return accountOwnerEquityID;
    }

    public void setAccountOwnerEquityID(Long accountOwnerEquityID) {
        this.accountOwnerEquityID = accountOwnerEquityID;
    }
