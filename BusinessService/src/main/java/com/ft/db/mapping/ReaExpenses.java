 ...
 * @author Tang
 */
public class ReaExpenses {
    private Long reaExpensesID;
    ...
    public Long getReaExpensesID() {
        return reaExpensesID;
    }

    public void setReaExpensesID(Long reaExpensesID) {
        this.reaExpensesID = reaExpensesID;
    }
