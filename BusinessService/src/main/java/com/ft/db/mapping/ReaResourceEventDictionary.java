 ...
 * @author Tang
 */
public class ReaResourceEventDictionary {
    private Long reaResourceEventDictionaryID;
    ...
    public Long getReaResourceEventDictionaryID() {
        return reaResourceEventDictionaryID;
    }

    public void setReaResourceEventDictionaryID(Long reaResourceEventDictionaryID) {
        this.reaResourceEventDictionaryID = reaResourceEventDictionaryID;
    }
