 ...
 * @author Tang
 */
public class TaxesPayableAccount {
    private String taxesPayableAccountID ;
    ...
    public String getTaxesPayableAccountID() {
        return taxesPayableAccountID;
    }

    public void setTaxesPayableAccountID(String taxesPayableAccountID) {
        this.taxesPayableAccountID = taxesPayableAccountID;
    }
