 ...
 * @author Tang
 */
public class DeferredProfitsAccount {
    private String deferredProfitsAccountID ;
    ...
    public String getDeferredProfitsAccountID() {
        return deferredProfitsAccountID;
    }

    public void setDeferredProfitsAccountID(String deferredProfitsAccountID) {
        this.deferredProfitsAccountID = deferredProfitsAccountID;
    }
