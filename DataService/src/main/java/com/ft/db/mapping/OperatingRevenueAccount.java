 ...
 * @author Tang
 */
public class OperatingRevenueAccount {
    private String operatingRevenueAccountID ;    
    ...
    public String getOperatingRevenueAccountID() {
        return operatingRevenueAccountID;
    }

    public void setOperatingRevenueAccountID(String operatingRevenueAccountID) {
        this.operatingRevenueAccountID = operatingRevenueAccountID;
    }
